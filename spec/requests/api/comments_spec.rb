...
RSpec.describe 'CommentsAPI', type: :request do
  ...
  describe 'GET /comments/:id' do
    it 'show comments on image' do
      get "/api/v1/comments/#{comment.id}", params: {}, headers: { 'HTTP_TOKEN_USER' => user.api_token.to_s }
  ...
  describe 'DELETE /comments/' do
    it 'delete comment' do
      delete '/api/v1/comments/', params: { id_comment: comment.id }, headers: { 'HTTP_TOKEN_USER' => user.api_token.to_s }
      result = JSON.parse response.body
