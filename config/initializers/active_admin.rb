...
ActiveAdmin.setup do |config|
  ...
  #
  # To change the default utility navigation to
  # show a link to your website & a logout btn
  #
  #   config.namespace :admin do |admin|
  ...
  #   end
  #
  # If you wanted to add a static menu item to the dkip_before_action
  # :authenticate_user!efault menu provided:
  #
  #   config.namespace :admin do |admin|
