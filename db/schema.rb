...
# fromscratch.Thelatter is flawed&unsustainable approach (the more migrations
...
ActiveRecord::Schema.define(version: 20180319063305) do
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.index ['commentable_id', 'commentable_type'],
            name: 'index_comments_on_commentable_id_and_commentable_type'
  ...
  create_table 'votes', force: :cascade do |t|
    ...
    t.index ['voter_id', 'voter_type', 'vote_scope'],
